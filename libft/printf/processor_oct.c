...
char	*add_alternative_form_o(char *str, va_list *ap)
{
	char			*result;
	unsigned int	i;
...
char	*processor_oct(t_format form, va_list *ap, unsigned long long int a)
{
	char			*str;
...
char	*processor_o(t_format *f, va_list *ap)
{
	...
	result = processor_oct(form, ap, a);
	return (result);
}
